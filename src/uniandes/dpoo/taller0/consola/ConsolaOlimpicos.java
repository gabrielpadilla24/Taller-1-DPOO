...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
	    ...
	    System.out.println("13. Consultar el país de un atleta dado su nombre"); //Cambio Modificacion 1
		System.out.println("14. Salir de la aplicación\n");

	}

	//Cambio Modificacion 1
	private void ejecutarPaisDeAtleta()
	{
	    System.out.println("\n" + "Consultar el país de un atleta dado su nombre" + "\n");
	    String nombreAtleta = input("Por favor ingrese el nombre del atleta");
	    String pais = calculadora.paisDeAtleta(nombreAtleta);
	    if (pais != null && !pais.isEmpty())
	        System.out.println("El atleta " + nombreAtleta + " es de " + pais);
	    else
	        System.out.println("No se encontró un atleta con el nombre: " + nombreAtleta);
